...
if __name__ == '__main__':
	results1 = pd.read_csv(f'wk_real_results/results1.csv')
	results2 = pd.read_csv(f'wk_real_results/results2.csv')
	results_corr = pd.read_csv(f'wk_real_results/results_corr.csv')
